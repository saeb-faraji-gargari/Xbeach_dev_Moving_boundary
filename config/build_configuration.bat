...
:VS2017
set devenv_path="C:\Program Files\Microsoft Visual Studio\2017\Professional\Common7\IDE"
IF EXIST "C:\Program Files (x86)\" set devenv_path="C:\Program Files (x86)\Microsoft Visual Studio\2017\Professional\Common7\IDE"
GOTO COMPILE
