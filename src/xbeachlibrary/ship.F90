...
contains
   ...
   subroutine ship_force(i,sh,s,par)
     ...
     ! write(*,*)i, xmpi_rank,s%shipFx(i), 'before'
#ifdef USEMPI
         call xmpi_allreduce(s%shipFx(i),MPI_SUM)
         call xmpi_allreduce(s%shipFy(i),MPI_SUM)
         call xmpi_allreduce(s%shipFz(i),MPI_SUM)
         call xmpi_allreduce(s%shipMx(i),MPI_SUM)
         call xmpi_allreduce(s%shipMy(i),MPI_SUM)
         call xmpi_allreduce(s%shipMz(i),MPI_SUM)
#endif
    !  write(*,*)i, xmpi_rank,s%shipFx(i), 'after'
